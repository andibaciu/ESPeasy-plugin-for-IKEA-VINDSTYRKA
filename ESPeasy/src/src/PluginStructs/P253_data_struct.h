...
#define PLUGIN_253_DEBUG  false
#else
#define PLUGIN_253_DEBUG  false        // set to true for extra log info in the debug
#endif
...
//struct P253_data_struct : public PluginTaskData_base
class P253_data_struct 
{

public:
  P253_data_struct();
  //virtual ~P253_data_struct();
  ~P253_data_struct();
